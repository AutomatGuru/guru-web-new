            ...
            <AnimatePresence>
                {open && (
                    ...
                    >
                        ...
                        {/* Close button - Fixed to ensure visibility */}
                        <motion.button
                            className="fixed top-6 right-6 z-50 w-12 h-12 rounded-full bg-white/5 border border-white/10 flex items-center justify-center text-neutral-400 hover:text-white hover:bg-white/10 transition-all duration-300 cursor-pointer"
                            onClick={handleClose}
                        ...
                        >
                            <div className="flex min-h-full items-center justify-center p-4 py-20 md:p-8">
                                {/* Form container */}
                                <motion.div
